...
class Tetris:
    ...
    # Set up the pieces for each rotation (0, 90, 180, 270)
    TETROMINOS = {
        0: { # I
            0: [(0,0), (1,0), (2,0), (3,0)],
            90: [(1,0), (1,1), (1,2), (1,3)],
    ...
    def render(self):
        ...
        img = np.array(img)
        cv2.putText(img, text=str(self.score), org=(22, 22), fontFace=cv2.FONT_HERSHEY_SIMPLEX, fontScale=1, color=(255, 255, 255), thickness=1)
